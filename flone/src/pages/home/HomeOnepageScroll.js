...
const HomeOnepageScroll = () => {
  ...
  return (
    <Fragment>
      <MetaTags>
        <title>Bosphorus | Fashion Home</title>
        <meta
          name="description"
          content="Fashion home of Bosphorus react minimalist eCommerce template."
        />
      </MetaTags>
        ...
        <SectionsContainer {...options} className="bg-purple-2">
          {sliderData &&
            sliderData.map((single, key) => {
              return (
                <Section key={key}>
                  <div className="slider-section Bosphorus-fp-section">
