        ...
        <ul>
          ...
          <li>
            ...
            <ul className="submenu">
              <li>
             {/* // https://drive.google.com/file/d/1fA0U158FTXm3IkjRULCWVcxxUcre5Mpi/view */}
                <a href="/assets/pdf/Hotel_Supply_Catalog.pdf" target="_blank">
                  {strings["Textile"]}
                </a>
              </li>
            
              <li>
                <a href="https://drive.google.com/file/d/1tGtYzBo50NKBPB0RW7XQeoHm0xKt5Fu2/view" target="_blank" >
                  {strings["Amenities"]}
                </a>
              </li>
              <li>
                <a href="/assets/pdf/CATALOG_CLINIC_EQUIPMENT.pdf" target="_blank" >
                  {strings["Clinic_Equipments"]}
                </a>
              </li>
              <li>
                <a href="/assets/pdf/CATALOG_CLINIC_EQUIPMENT.pdf" target="_blank" >
                  {strings["Medical_devices_supply"]}
                </a>
              </li>
              <li>
                <a href="https://drive.google.com/file/d/1sHqij6ofBTTjMXImAP2embLPi1-84UT2/view" target="_blank">
                  {strings["Electronics"]}
                </a>
              </li>
            
              <li>
                <a href="https://drive.google.com/file/d/1_8OAJADJgzQn96Zd6rHTjNetT9g22nqP/view" target="_blank">
                  {strings["General_Equipments"]}
                </a>
              </li>
